...
Municipal Infrastructure Anomaly Detection is a smart city monitoring platform built to help municipalities identify and respond to infrastructure risks faster. The system combines sensor anomaly detection, leak and overflow sequence analysis, water quality monitoring, incident management, crew routing, GIS dashboards, and computer vision for illegal dumping detection.
...
- **Backend:** FastAPI, SQLAlchemy, Pydantic, SQLite/PostgreSQL, Redis
